    ...
    <div>
      ...
      <section className="dark:bg-darkBg bg-bg py-20 font-base lg:py-[100px]">
        <h2 className="mb-14 px-5 text-center text-2xl font-heading md:text-3xl lg:mb-20 lg:text-4xl">
          Frequently Asked Questions (Neobrutalism Style)
        </h2>
        ...
        <div className="mx-auto grid w-[700px] max-w-full px-5">
          <Accordion className="text-base sm:text-lg" type="single" collapsible>
            <AccordionItem className="mb-2" value="item-1">
              <AccordionTrigger>What is Neobrutalism Design?</AccordionTrigger>
              <AccordionContent>
                Neobrutalism is a design trend inspired by the Brutalist architectural style, focusing on bold colors, sharp edges, and minimalistic design elements, often combined with chaotic or raw aesthetics.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem className="mb-2" value="item-2">
              <AccordionTrigger>How can I use Neobrutalism in web design?</AccordionTrigger>
              <AccordionContent>
                You can apply neobrutalism by using bright colors, strong typography, raw and unpolished UI elements, and mixing 3D graphics with a flat, minimalistic layout.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem className="mb-2" value="item-3">
              <AccordionTrigger>Is Neobrutalism suitable for all websites?</AccordionTrigger>
              <AccordionContent>
                Neobrutalism may not suit all websites. It works best for modern, creative projects, portfolios, or experimental sites where you want to make a strong visual impact.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-4">
              <AccordionTrigger>What tools can I use to design Neobrutalist websites?</AccordionTrigger>
              <AccordionContent>
                Tools like Figma, Adobe XD, or even basic HTML/CSS with frameworks like Tailwind CSS can help you create Neobrutalist designs with ease.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
      ...
      {/* Marquee component with neobrutalist style */}
      <div>
        <Marquee
